                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        >
                          {settings?.globalFreeMode ? "فعال (مطالعه رایگان با ورود/ثبت‌نام)" : "غیرفعال (حالت پولی عادی)"}
                        </span>
                      </div>
                      <p className="text-xs text-zinc-400 mt-0.5">
                        {settings?.globalFreeMode
                          ? "اعضای وارد شده بدون پرداخت و بدون ثبت خرید چپترها را می‌خوانند؛ مهمانان برای دسترسی رایگان به ورود/ثبت‌نام هدایت می‌شوند."
